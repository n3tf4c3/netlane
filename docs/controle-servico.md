...
- A sessão depende da janela. Bandeja, execução após fechar a UI e inicialização automática não fazem parte desta entrega. Um ciclo real de suspensão/retomada preservou a sessão em 2026-09-09; isso não garante todos os cenários de energia, e keepalive vencido pode encerrar a sessão por segurança.
